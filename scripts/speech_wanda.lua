...
---- Mapel ----
		MAPEL =
		{
		GENERIC = "Mapel is always with me. always",
		CHARGED_POCKET = "Ready to play Mapel?",
		CHARGED_GROUND = "I can't play with her if shes lying there.",
		BROKEN_POCKET = "Were did she go?",
		BROKEN_GROUND = "Will she come back if I leave her alone?",
		NORMAL_POCKET = "The brightest Star in the dakest night",
		NORMAL_GROUND = "I shouldn't leave her alone...",
		},
